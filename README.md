# Curso de Desarrollador Programador Web - Camada 3635 💾
...
4. Entren al repositorio haciendo `cd programadorWeb-3635`. 
5. Luego ejecuten el comando `git remote add profe https://github.com/adrianc4/programadorWeb-3635` para vincular su repo con el mio.
